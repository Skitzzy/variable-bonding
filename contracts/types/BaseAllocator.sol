 ...
 * @title BaseAllocator
 * @notice
 *  This abstract contract serves as a template for writing new Fyde Allocators.
 ...
 */
abstract contract BaseAllocator is FydeAccessControlledV2, IAllocator {
    ...
    constructor(AllocatorInitData memory data) FydeAccessControlledV2(data.authority) {
        _tokens = data.tokens;
