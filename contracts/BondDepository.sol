...
/// @title Fyde Bond Depository V2
/// @author Zeus, Indigo
/// Review by: JeffX

contract BondingContract is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
     ...
     * @return payout_     the amount of gMGMT due
        ...
        )
    {
         ...
         * price = quote tokens : mgmt (i.e. 42069 DAI : MGMT)
         *
         * 1e18 = MGMT decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of MGMT that the market can sell
        ...
        // purchased, and how much MGMT has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
             ...
             * is 10,000 MGMT. max payout would be 1,000 MGMT (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in MGMT or quote), initial price / MGMT (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         * interval. for example, if capacity is 1,000 MGMT, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 MGMT.
         */
     ...
     * @param _id          ID of market
     * @return             price for market in MGMT decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of MGMT to be paid in MGMT decimals
     *
     ...
     * @param _id          ID of market
     * @return             current debt for market in MGMT decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in MGMT decimals
     */
