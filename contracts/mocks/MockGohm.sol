...
// TODO fulfills IgMGMT but is not inheriting because of dependency issues
contract MockGMGMT is MockERC20 {
    /* ========== CONSTRUCTOR ========== */

    uint256 public immutable index;

    constructor(uint256 _initIndex) MockERC20("Governance MGMT", "gMGMT", 18) {
        index = _initIndex;
    }

    function migrate(address _staking, address _sMGMT) external {}
