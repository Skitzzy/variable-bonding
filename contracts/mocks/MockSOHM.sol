...
/**
 * A mock version of sMGMT, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSMGMT is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20("Mock sMGMT", "sMGMT") {
