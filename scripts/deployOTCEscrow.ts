...
async function main() {
    ...
    const FydeMS = "0x245cc372C84B3645Bf0Ffe6538620B04a217988B";
    const tradePartnerMS = "0x5A21f270492E55Fec2CC78C627618cAE42295695";

    const FydeToken = "0x0ab87046fBb341D058F17CBC4c1133F25a20a52f";
    const externalToken = "0x0391D2021f89DC339F60Fff84546EA23E337750f";

    const FydeAmount = "193550000000000000000";
